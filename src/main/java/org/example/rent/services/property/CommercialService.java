...
public class CommercialService extends PropertyService<Commercial, CommercialDTO> {
    ...
    public CommercialService(CommercialRepository commercialRepository, PropertyMapper propertyMapper, PhotoService photoService, PhotoMapper photoMapper) {
        super(commercialRepository, propertyMapper, photoService, photoMapper);
