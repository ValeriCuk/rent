...
public class HouseService extends PropertyService<House, HouseDTO> {
    ...
    public HouseService(HouseRepository houseRepository, PropertyMapper propertyMapper, PhotoService photoService, PhotoMapper photoMapper) {
        super(houseRepository, propertyMapper, photoService, photoMapper);
